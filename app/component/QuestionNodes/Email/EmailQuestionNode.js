...
function EmailQuestionNode({ data, selected, id, updateUserName }) {
          ...
          {userData ? (
            <div className="py-2">
              <p className="font-semibold text-sm text-gray-700 mt-2">
                {data.label === "emailquestionnode" ? "Enter Your Email" : data.label}
              </p>
              <div className="relative w-full">
                <input
                  ...
                  placeholder={`Enter Your ${selectedField || "Email"}...`}
                />
                <button
